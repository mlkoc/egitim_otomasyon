    ...
    public void baglan() {
        try {
            if (kontrol()) {
                ...
                /*encoding*/
                conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/kurs_otomasyon?useUnicode=true&useLegacyDatetimeCode=false&serverTimezone=Turkey", "root", "xxx"); // xxx yerine mysql şifresini girmeyi unutmayın
