...
public class MailForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 10, 130, -1));

        jLabel15.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel15.setText("MAİL GÖNDERME İŞLEMLERİ");
            ...
            Runnable task2 = () -> {
                ...
                while (jTable1.getRowCount() > i) {
                    ...
                    try {
                        ...
                        mesaj.setSubject("KOÇ Akademi Veli Bilgilendirme Sistemi");
    ...
    private void tekGndrActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tekGndrActionPerformed
        ...
        if (secim > 0) {
            ...
            Session session = Session.getDefaultInstance(pro,
                ...
                protected PasswordAuthentication getPasswordAuthentication() {
                    return new PasswordAuthentication("xxx@hotmail.com", "xx"); /////// MAİL ADRESİ VE ŞİFREYİ GİRMEYİ UNUTMA 15.04.2020
                }
            });
            ...
            Runnable task2 = () -> {
                ...
                try {
                    Message mesaj = new MimeMessage(session);
                    mesaj.setFrom(new InternetAddress("XXX@hotmail.com")); // MAİL ADRESİ GİRİNİZ
